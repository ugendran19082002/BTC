...
| `market_states` | every market state the desk has called (breakout / rejection / breakdown / range), with the plan it implied and, four bars later, whether it came good | on change | 90 days | recording since 23 Sep 2026 |
