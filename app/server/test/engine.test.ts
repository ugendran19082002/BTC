...
import { hashPassword, verifyPassword, readCookie } from '../src/http/session.js';

// Sessions, their expiry and the sign-in limits moved to auth.db; they are
// tested end to end in test/http/auth-flow.test.ts.
