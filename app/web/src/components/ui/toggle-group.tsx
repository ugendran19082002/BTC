...
>(({ className, ...props }, ref) => (
  <TG.Root ref={ref} className={cn('inline-flex gap-0.5 rounded-lg bg-muted p-0.5', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TG.Item
    ...
    className={cn(
      ...
      'inline-flex h-7 flex-1 items-center justify-center rounded-md px-2.5 text-[12.5px] font-medium',
